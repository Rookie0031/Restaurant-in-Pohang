//
//  FoodRecommendVM.swift
//  WhatToEat?
//
//  Created by Jisu Jang on 2023/09/03.
//

import SwiftUI
import Combine

final class FoodRecommendVM: ObservableObject {

    @Published var filteredFoods: [Properties] = []
